...
/** 
*@struct bitree database.h database.h
*@brief Struct for the database.
*
...
struct bitree{
  ...
  char *value; /**< The value for the entry */
  struct bitree *left; /**< The left child node */
  struct bitree *right; /**< The right child node */
};
